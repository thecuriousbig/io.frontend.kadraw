							...
							<Segment style={{ height: '100%' }}>
								<Grid style={{ padding: '32px' }}>
									<Grid.Row textAlign="center" style={{ padding: '0px' }}>
										<h1 style={{ color: '#3a6bff', width: '100%', padding: '0px' }}>
											Player ({users.length} / {numberOfPlayer})
										</h1>
									</Grid.Row>
									<Grid.Row style={{ minHeight: '470px', maxHeight: '470px', overflow: 'auto' }}>
										<Segment style={{ width: '100%', minheight: '100%', padding: '0px' }}>
