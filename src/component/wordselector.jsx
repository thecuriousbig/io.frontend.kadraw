...
class WordSelector extends Component{
    ...
    handleChange =  (event, data) => {
		if (event.target.name === 'changeword') {
            ...
            this.sendData(this.state.easyWord, this.state.easyWordHint)
		} else if(event.target.name === 'selectnormalword'){
            this.sendData(this.state.normalWord,this.state.normalWordHint)
        } else if(event.target.name === 'selecthardword'){
            this.sendData(this.state.hardWord,this.state.hardWordHint)
        }else{
    ...
    sendData = async(word, hint) => {
         let playroomRef = firebase.firestore().collection('PlayRoom').doc(this.state.roomNumber)
